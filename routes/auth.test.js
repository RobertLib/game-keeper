...
describe("POST /auth/login", () => {
  it("should log in a user with correct email and password", async () => {
    ...
    /** @type {jest.Mock} */ (bcrypt.compare).mockResolvedValueOnce(true);
    /** @type {jest.Mock} */ (jwt.sign).mockReturnValueOnce(token);
  ...
  it("should return 400 for incorrect password", async () => {
    ...
    /** @type {jest.Mock} */ (bcrypt.compare).mockResolvedValueOnce(false);
  ...
  it("should return 500 for server error", async () => {
    /** @type {jest.Mock} */ (db.query).mockRejectedValueOnce(
...
describe("POST /auth/register", () => {
  it("should register a new user", async () => {
    ...
    /** @type {jest.Mock} */ (bcrypt.hash).mockResolvedValueOnce(
      "hashedpassword"
    );
    /** @type {jest.Mock} */ (jwt.sign).mockReturnValueOnce(token);
